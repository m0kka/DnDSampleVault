...
```
<% await tp.file.move("/3-Compendium/Guilds and Groups/" + tp.file.title) %>
...
- `/3-Compendium/Guilds and Groups/` This is the folder path where the Template will save new notes made with the template. 
