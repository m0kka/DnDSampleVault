...
To attempt a crime, the character makes three checks: Dexterity (Stealth), Dexterity using [thieves' tools](thieves-tools-xphb.md), and the player's choice of Intelligence (Investigation), Wisdom (Perception), or Charisma (Deception).
