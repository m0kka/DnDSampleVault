...
| 4 | Escort a [Returned sentry](returned-sentry-mot.md) (see "chapter 6") escaping from the Underworld into the mortal world. |
| 5 | Bargain with a [lampad](lampad-mot.md) (see "chapter 6") to learn where the body of a lost hero lies entombed. |
...
| 12 | Capture an [Underworld cerberus](underworld-cerberus-mot.md) (see "chapter 6"). |
^underworld-crossing-adventures