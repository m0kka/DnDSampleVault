...
| 5 | Kill or drive off a [hydra](hydra.md) that has claimed the temple as its home. |
| 6 | Help a [killer whale](killer-whale.md) beached in the temple. |
| 7 | Get information from a worshiper. |
| 8 | Kidnap a worshiper without making a scene. |
| 9 | Steal a magic [quipper](quipper.md) from a sacred tide pool. |
