...
| 19–27 | Local plants and animals share a malevolent intelligence. Roll a `d6`. On a 1–2, an insect plague spell is centered on one random creature in the region. On a 3–4, `1d4` [swarms of ravens](swarm-of-ravens.md) and `1d4` [swarms of rats](swarm-of-rats.md) gather and attack any other creatures in the region. On a 5–6, a [treant](treant.md) (in forested terrain) or a [galeb duhr](galeb-duhr.md) (in rockier terrain) attacks. |
...
| 37–45 | The landscape melts into a mass of writhing flesh, eyes, and fanged mouths. From an unoccupied space in the fleshy ground arise `1d4 + 5` [gibbering mouthers](gibbering-mouther.md) that attack anyone in sight. |
