...
aliases: ["Vine Blight"]
---
# [Vine Blight](3-Compendium\CLI\bestiary\plant/vine-blight.md)
*Source: Monster Manual p. 32, Explorer's Guide to Wildemount, Dragon of Icespire Peak, The Book of Many Things*  
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one target. Hit: 9 (2d6\
    \ + 2) bludgeoning damage, and a Large or smaller target is grappled (escape DC\
    \ 12). Until this grapple ends, the target is restrained, and the blight can't\
...
- "DIP"
- "BMT"
"image": "bestiary/tokens/MM/Vine Blight.webp"
```
^statblock
