...
---
# [Shambling Mound](3-Compendium\CLI\bestiary\plant/shambling-mound.md)
...
- "desc": "The shambling mound engulfs a Medium or smaller creature grappled by it.\
    ...
    \ succeed on a DC 14 Constitution saving throw at the start of each of the mound's\
    \ turns or take 13 (2d8 + 4) bludgeoning damage. If the mound moves, the engulfed\
    \ target moves with it. The mound can have only one creature engulfed at a time."
  "name": "Engulf"
"source":
- "MM"
- "MOT"
- "BMT"
"image": "bestiary/tokens/MM/Shambling Mound.webp"
```
^statblock
