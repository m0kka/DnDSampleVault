...
aliases: ["Treant"]
---
# [Treant](3-Compendium\CLI\bestiary\plant/treant.md)
...
- "desc": "The treant magically animates one or two trees it can see within 60 feet\
    \ of it. These trees have the same statistics as a [treant](/3-Compendium/CLI/bestiary/plant/treant.md),\
...
- "TCE"
- "BMT"
"image": "bestiary/tokens/MM/Treant.webp"
```
^statblock
