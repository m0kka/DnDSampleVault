...
---
# [Ancient Emerald Dragon](3-Compendium\CLI\bestiary\dragon/ancient-emerald-dragon-ftd.md)
...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ detect thoughts, dispel magic, etherealness, major image, mislead"
...
- "desc": "The dragon can burrow through solid rock at half its burrowing speed and\
  ...
  "name": "Tunneler"
- "desc": "The dragon can cast mirage arcane, requiring no spell components and using\
...
"source":
- "FTD"
"image": "bestiary/tokens/FTD/Ancient Emerald Dragon.webp"
```
^statblock