...
---
# [Topaz Dragon Wyrmling](3-Compendium\CLI\bestiary\dragon/topaz-dragon-wyrmling-ftd.md)
...
- "desc": "The dragon exhales yellowish necrotic energy in a 15-foot cone. Each creature\
    ...
    \ the creature takes 21 (6d6) necrotic damage and is weakened until the end of\
...
"source":
- "FTD"
"image": "bestiary/tokens/FTD/Topaz Dragon Wyrmling.webp"
```
^statblock