...
---
# [Young Amethyst Dragon](3-Compendium\CLI\bestiary\dragon/young-amethyst-dragon-ftd.md)
...
```statblock
"name": "Young Amethyst Dragon (FTD)"
"size": "Large"
"type": "dragon"
"subtype": "gem"
...
- "desc": "The dragon casts one of the following spells, requiring no spell components\
    ...
    \ each: blink, dispel magic, protection from evil and good, sending"
...
"source":
- "FTD"
"image": "bestiary/tokens/FTD/Young Amethyst Dragon.webp"
```
^statblock