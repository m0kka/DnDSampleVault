...
aliases: ["Aarakocra"]
---
# [Aarakocra](3-Compendium\CLI\bestiary\humanoid/aarakocra.md)
...
- "desc": "Five aarakocra within 30 feet of each other can magically summon an [air\
    \ elemental](/3-Compendium/CLI/bestiary/elemental/air-elemental.md). Each of the\
    \ five must use its action and movement on three consecutive turns to perform\
    \ an aerial dance and must maintain concentration while doing so (as if concentrating\
...
- "MM"
- "EGW"
"image": "bestiary/tokens/MM/Aarakocra.webp"
```
^statblock
