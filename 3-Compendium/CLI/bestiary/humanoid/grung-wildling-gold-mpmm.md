...
---
# [Grung Wildling (Gold)](3-Compendium\CLI\bestiary\humanoid/grung-wildling-gold-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 150, Volo's Guide to Monsters p. 157*  

```statblock
"name": "Grung Wildling (Gold) (MPMM)"
"size": "Small"
"type": "humanoid"
...
- "desc": "A creature poisoned by a grung suffers an additional effect that depends\
    ...
    \ by the grung. The creature is charmed by the grung and can speak Grung."
  "name": "Poisonous Skin"
