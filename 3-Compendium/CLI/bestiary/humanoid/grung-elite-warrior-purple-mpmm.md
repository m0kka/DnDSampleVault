...
---
# [Grung Elite Warrior (Purple)](3-Compendium\CLI\bestiary\humanoid/grung-elite-warrior-purple-mpmm.md)
...
- "desc": "A creature poisoned by a grung suffers an additional effect that depends\
    ...
    \ by the grung. The poisoned creature feels a desperate need to soak itself in\
    \ liquid or mud. It can't take actions or move except to do so or to reach a body\
    \ of liquid or mud."
  "name": "Poisonous Skin"
