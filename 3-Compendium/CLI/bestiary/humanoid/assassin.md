...
aliases: ["Assassin"]
---
# [Assassin](3-Compendium\CLI\bestiary\humanoid/assassin.md)
...
- "desc": "The assassin deals an extra 14 (4d6) damage when it hits a target with\
    ...
    \ within 5 feet of an ally of the assassin that isn't incapacitated and the assassin\
...
- "MOT"
- "TCE"
"image": "bestiary/tokens/MM/Assassin.webp"
```
^statblock
