...
---
# [Meletian Hoplite](3-Compendium\CLI\bestiary\humanoid/meletian-hoplite-mot.md)
...
- "desc": "The hoplite is a 3rd-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ frost (see \"Actions\" below)\n\n1st level (4 slots): color spray, expeditious\
...
- "desc": "Ranged Spell Attack: +5 to hit, range 60 ft., one creature. Hit: 4\
    ...
    \ of the hoplite's next turn."
  "name": "Ray of Frost (Cantrip)"
"source":
- "MOT"
"image": "bestiary/tokens/MOT/Meletian Hoplite.webp"
```
^statblock