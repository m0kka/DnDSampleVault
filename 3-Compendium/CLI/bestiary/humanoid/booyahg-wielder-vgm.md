...
---
# [Booyahg Wielder](3-Compendium\CLI\bestiary\humanoid/booyahg-wielder-vgm.md)
...
- "desc": "The goblin can take the Disengage or Hide action as a bonus action on each\
    \ of its turns."
  "name": "Nimble Escape"
- "desc": "The goblin found a magic item (a necklace of fireballs, a circlet of blasting,\
...
"source":
- "VGM"
"image": "bestiary/tokens/VGM/Booyahg Wielder.webp"
```
^statblock