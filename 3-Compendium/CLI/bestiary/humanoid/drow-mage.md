...
aliases: ["Drow Mage"]
---
# [Drow Mage](3-Compendium\CLI\bestiary\humanoid/drow-mage.md)
*Source: Monster Manual p. 129, Dragon of Icespire Peak*  
...
- "desc": "Melee Weapon Attack: +2 to hit, reach 5 ft., one target. Hit: 2 (1d6\
  ...
  "name": "Staff"
- "desc": "The drow magically summons a [quasit](/3-Compendium/CLI/bestiary/fiend/quasit-xphb.md),\
    \ or attempts to summon a [shadow demon](/3-Compendium/CLI/bestiary/fiend/shadow-demon.md)\
...
- "MM"
- "DIP"
"image": "bestiary/tokens/MM/Drow Mage.webp"
```
^statblock
