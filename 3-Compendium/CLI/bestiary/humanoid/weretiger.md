...
aliases: ["Weretiger"]
---
# [Weretiger](3-Compendium\CLI\bestiary\humanoid/weretiger.md)
*Source: Monster Manual p. 210, Explorer's Guide to Wildemount. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "If the weretiger moves at least 15 feet straight toward a creature and\
    ...
    \ a DC 14 Strength saving throw or be knocked prone. If the target is prone, the\
...
- "MM"
- "EGW"
"image": "bestiary/tokens/MM/Weretiger.webp"
```
^statblock
