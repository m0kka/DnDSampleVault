...
aliases: ["Werewolf"]
---
# [Werewolf](3-Compendium\CLI\bestiary\humanoid/werewolf.md)
*Source: Monster Manual p. 211, Eberron: Rising from the Last War, Explorer's Guide to Wildemount, The Book of Many Things. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "The werewolf can use its action to polymorph into a wolf-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The werewolf has advantage on Wisdom (Perception) checks that rely on hearing\
    \ or smell."
...
- "EGW"
- "BMT"
"image": "bestiary/tokens/MM/Werewolf.webp"
```
^statblock
