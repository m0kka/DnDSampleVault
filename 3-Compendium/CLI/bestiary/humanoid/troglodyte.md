...
aliases: ["Troglodyte"]
---
# [Troglodyte](3-Compendium\CLI\bestiary\humanoid/troglodyte.md)
...
- "desc": "Any creature other than a troglodyte that starts its turn within 5 feet\
    \ of the troglodyte must succeed on a DC 12 Constitution saving throw or be poisoned\
...
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Troglodyte.webp"
```
^statblock
