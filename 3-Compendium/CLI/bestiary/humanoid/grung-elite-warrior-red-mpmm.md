...
---
# [Grung Elite Warrior (Red)](3-Compendium\CLI\bestiary\humanoid/grung-elite-warrior-red-mpmm.md)
...
- "desc": "A creature poisoned by a grung suffers an additional effect that depends\
    ...
    \ by the grung. The poisoned creature must use its action to eat if food is within\
    \ reach."
  "name": "Poisonous Skin"
