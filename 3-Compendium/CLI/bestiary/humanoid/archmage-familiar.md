...
---
# [Archmage (Familiar)](3-Compendium\CLI\bestiary\humanoid/archmage-familiar.md)
...
- "desc": "The archmage is an 18th-level spellcaster. Its spellcasting ability is\
    ...
    \ level (4 slots): detect magic, find familiar (one of the creatures described\
    \ in the spell or some other Tiny monster, such as a [crawling claw](/3-Compendium/CLI/bestiary/undead/crawling-claw.md),\
    \ [imp](/3-Compendium/CLI/bestiary/fiend/imp-xphb.md), [pseudodragon](/3-Compendium/CLI/bestiary/dragon/pseudodragon-xphb.md),\
    \ or [quasit](/3-Compendium/CLI/bestiary/fiend/quasit-xphb.md)), identify, mage\
    \ armor, magic missile\n\n2nd level (3 slots): detect thoughts, mirror image,\
    \ misty step\n\n3rd level (3 slots): counterspell, fly, lightning bolt\n\n\
    4th level (3 slots): banishment, fire shield, stoneskin\n\n5th level (3\
    \ slots): cone of cold, scrying, wall of force\n\n6th level (1 slots): globe\
