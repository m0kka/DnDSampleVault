...
---
# [Grung Elite Warrior (Orange)](3-Compendium\CLI\bestiary\humanoid/grung-elite-warrior-orange-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 150, Volo's Guide to Monsters p. 157*  

```statblock
"name": "Grung Elite Warrior (Orange) (MPMM)"
"size": "Small"
"type": "humanoid"
...
- "desc": "A creature poisoned by a grung suffers an additional effect that depends\
    ...
    \ by the grung. The poisoned creature is frightened of its allies."
  "name": "Poisonous Skin"
