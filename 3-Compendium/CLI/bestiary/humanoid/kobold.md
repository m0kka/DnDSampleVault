...
aliases: ["Kobold"]
---
# [Kobold](3-Compendium\CLI\bestiary\humanoid/kobold.md)
*Source: Monster Manual p. 195, Eberron: Rising from the Last War, Explorer's Guide to Wildemount. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "ERLW"
- "EGW"
"image": "bestiary/tokens/MM/Kobold.webp"
```
^statblock
