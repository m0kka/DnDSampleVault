...
---
# [Grung Wildling (Blue)](3-Compendium\CLI\bestiary\humanoid/grung-wildling-blue-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 150, Volo's Guide to Monsters p. 157*  

```statblock
"name": "Grung Wildling (Blue) (MPMM)"
"size": "Small"
"type": "humanoid"
...
- "desc": "A creature poisoned by a grung suffers an additional effect that depends\
    ...
    \ by the grung. The poisoned creature must make a loud noise at the start and\
    \ end of its turn."
  "name": "Poisonous Skin"
