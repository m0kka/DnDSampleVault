...
---
# [Vampire Spawn](3-Compendium\CLI\bestiary\undead/vampire-spawn.md)
*Source: Monster Manual p. 298, Dragon of Icespire Peak, Explorer's Guide to Wildemount, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one willing creature, or\
    ...
    \ 6 (1d6 + 3) piercing damage plus 7 (2d6) necrotic damage. The target's hit point\
...
- "EGW"
- "TCE"
"image": "bestiary/tokens/MM/Vampire Spawn.webp"
```
^statblock
