...
aliases: ["Ogre Zombie"]
---
# [Ogre Zombie](3-Compendium\CLI\bestiary\undead/ogre-zombie.md)
*Source: Monster Manual p. 316, Dragon of Icespire Peak. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "MM"
- "DIP"
"image": "bestiary/tokens/MM/Ogre Zombie.webp"
```
^statblock