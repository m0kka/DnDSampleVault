...
---
# [Spawn of Kyuss](3-Compendium\CLI\bestiary\undead/spawn-of-kyuss-mpmm.md)
...
- "desc": "A worm launches from the spawn of Kyuss at one Humanoid that the spawn\
    ...
    \ takes 7 (2d6) necrotic damage per worm infesting it (maximum of 10d6), and if\
    \ it drops to 0 hit points, it dies and then rises 10 minutes later as a spawn\
...
- "MPMM"
- "VGM"
"image": "bestiary/tokens/MPMM/Spawn of Kyuss.webp"
```
^statblock
