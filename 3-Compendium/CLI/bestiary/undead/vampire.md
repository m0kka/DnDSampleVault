...
aliases: ["Vampire"]
---
# [Vampire](3-Compendium\CLI\bestiary\undead/vampire.md)
*Source: Monster Manual p. 297, Explorer's Guide to Wildemount, Tasha's Cauldron of Everything, The Book of Many Things. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "When it drops to 0 hit points outside its resting place, the vampire transforms\
    ...
    \ then paralyzed until it regains at least 1 hit point. After spending 1 hour\
    \ in its resting place with 0 hit points, it regains 1 hit point."
  "name": "Misty Escape"
...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ into the vampire's heart while the vampire is incapacitated in its resting place,\
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 5 ft., one willing creature, or\
    ...
    \ ground rises the following night as a [vampire spawn](/3-Compendium/CLI/bestiary/undead/vampire-spawn.md)\
...
- "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
    ...
    \ throw against this magic or be charmed by the vampire. The charmed target regards\
  ...
  "name": "Charm"
- "desc": "The vampire magically calls 2d4 swarms of [bats](/3-Compendium/CLI/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](/3-Compendium/CLI/bestiary/beast/swarm-of-rats.md), provided that the\
    \ sun isn't up. While outdoors, the vampire can call 3d6 [wolves](/3-Compendium/CLI/bestiary/beast/wolf-xphb.md)\
...
- "TCE"
- "BMT"
"image": "bestiary/tokens/MM/Vampire.webp"
```
^statblock
