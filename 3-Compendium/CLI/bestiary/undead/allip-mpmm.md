...
aliases: ["Allip"]
---
# [Allip](3-Compendium\CLI\bestiary\undead/allip-mpmm.md)
...
- "desc": "Each creature within 30 feet of the allip that can hear it must make a\
    ...
    \ damage, and it is stunned until the end of its next turn. On a successful save,\
    \ it takes half as much damage and isn't stunned. Constructs and Undead are immune\
    \ to this effect."
