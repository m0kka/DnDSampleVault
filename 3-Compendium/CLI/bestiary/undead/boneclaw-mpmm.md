...
aliases: ["Boneclaw"]
---
# [Boneclaw](3-Compendium\CLI\bestiary\undead/boneclaw-mpmm.md)
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 15 ft., one target. Hit: 20 (3d10\
    ...
    \ is grappled (escape DC 14). The boneclaw has two claws. While a claw grapples\
    \ a target, the claw can attack only that target."
  "name": "Piercing Claw"
...
- "MPMM"
- "MTF"
"image": "bestiary/tokens/MPMM/Boneclaw.webp"
```
^statblock
