...
aliases: ["Mummy Lord"]
---
# [Mummy Lord](3-Compendium\CLI\bestiary\undead/mummy-lord.md)
...
- "desc": "The mummy lord is a 10th-level spellcaster. Its spellcasting ability is\
    ...
    \ (3 slots): animate dead, dispel magic\n\n4th level (3 slots): divination,\
...
- "desc": "The mummy lord targets one creature it can see within 60 feet of it. If\
    ...
    \ throw against this magic or become frightened until the end of the mummy's next\
    \ turn. If the target fails the saving throw by 5 or more, it is also paralyzed\
...
- "desc": "The mummy lord utters a blasphemous word. Each non-undead creature within\
    ...
    \ a DC 16 Constitution saving throw or be stunned until the end of the mummy lord's\
    \ next turn."
...
- "desc": "The mummy lord magically transforms into a whirlwind of sand, moves up\
    ...
    \ lord is immune to all damage, and it can't be grappled, petrified, knocked prone,\
    \ restrained, or stunned. Equipment worn or carried by the mummy lord remain in\
    \ its possession."
  "name": "Whirlwind of Sand (Costs 2 Actions)"
"source":
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Mummy Lord.webp"
```
^statblock
