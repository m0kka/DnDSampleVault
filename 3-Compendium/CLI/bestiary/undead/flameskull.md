...
aliases: ["Flameskull"]
---
# [Flameskull](3-Compendium\CLI\bestiary\undead/flameskull.md)
...
- "desc": "The flameskull is a 5th-level spellcaster. Its spellcasting ability is\
    ...
    \ (3 slots): magic missile, shield\n\n2nd level (2 slots): blur, flaming\
...
- "desc": "If the flameskull is destroyed, it regains all its hit points in 1 hour\
    \ unless holy water is sprinkled on its remains or a dispel magic or remove curse\
...
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Flameskull.webp"
```
^statblock
