...
aliases: ["Wraith"]
---
# [Wraith](3-Compendium\CLI\bestiary\undead/wraith.md)
*Source: Monster Manual p. 302, Dragon of Icespire Peak, Explorer's Guide to Wildemount, Mythic Odysseys of Theros, Tasha's Cauldron of Everything, The Book of Many Things. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The wraith targets a humanoid within 10 feet of it that has been dead for\
    \ no longer than 1 minute and died violently. The target's spirit rises as a [specter](/3-Compendium/CLI/bestiary/undead/specter.md)\
    \ in the space of its corpse or in the nearest unoccupied space. The [specter](/3-Compendium/CLI/bestiary/undead/specter.md)\
...
- "TCE"
- "BMT"
"image": "bestiary/tokens/MM/Wraith.webp"
```
^statblock
