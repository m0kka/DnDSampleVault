...
---
# [Undying Soldier](3-Compendium\CLI\bestiary\undead/undying-soldier-erlw.md)
...
- "desc": "Melee or Ranged Weapon Attack: +5 to hit, reach 5 ft. or range 20/60\
    ...
    \ damage if used with two hands to make a melee attack, plus 9 (2d8) radiant damage\
    \ if the target is a fiend or undead."
  "name": "Spear"
"source":
- "ERLW"
"image": "bestiary/tokens/ERLW/Undying Soldier.webp"
```
^statblock