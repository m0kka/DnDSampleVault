...
---
# [Yuan-ti Abomination](3-Compendium\CLI\bestiary\monstrosity/yuan-ti-abomination.md)
*Source: Monster Manual p. 308, Dragon of Icespire Peak*  
...
- "desc": "Melee Weapon Attack: +7 to hit, reach 10 ft., one target. Hit: 11 (2d6\
    ...
    \ grapple ends, the target is restrained, and the yuan-ti can't constrict another\
    \ target."
  "name": "Constrict"
...
- "MM"
- "DIP"
"image": "bestiary/tokens/MM/Yuan-ti Abomination.webp"
```
^statblock
