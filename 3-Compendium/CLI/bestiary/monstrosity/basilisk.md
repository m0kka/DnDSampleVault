...
aliases: ["Basilisk"]
---
# [Basilisk](3-Compendium\CLI\bestiary\monstrosity/basilisk.md)
...
- "desc": "If a creature starts its turn within 30 feet of the basilisk and the two\
    ...
    \ 12 Constitution saving throw if the basilisk isn't incapacitated. On a failed\
    \ save, the creature magically begins to turn to stone and is restrained. It must\
...
- "MM"
- "MOT"
"image": "bestiary/tokens/MM/Basilisk.webp"
```
^statblock
