...
aliases: ["Dracohydra"]
---
# [Dracohydra](3-Compendium\CLI\bestiary\monstrosity/dracohydra-ftd.md)
...
- "desc": "The dracohydra has five heads. While it has more than one head, the dracohydra\
    ...
    \ damage in a single turn, one of its heads dies. If all its heads die, the dracohydra\
    \ dies.\n\nAt the end of its turn, the dracohydra grows two heads for each of\
    \ its heads that died since its last turn, unless it has taken radiant damage\
    \ since its last turn. The dracohydra regains 10 hit points for each head regrown\
    \ this way."
  "name": "Multiple Heads"
...
"source":
- "FTD"
"image": "bestiary/tokens/FTD/Dracohydra.webp"
```
^statblock