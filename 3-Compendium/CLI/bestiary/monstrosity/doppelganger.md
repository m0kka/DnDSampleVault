...
---
# [Doppelganger](3-Compendium\CLI\bestiary\monstrosity/doppelganger.md)
...
- "desc": "The doppelganger magically reads the surface thoughts of one creature within\
    ...
    \ on Wisdom (Insight) and Charisma (Deception, Intimidation, and Persuasion) checks\
    \ against the target."
  "name": "Read Thoughts"
"source":
- "MM"
- "EGW"
- "BMT"
"image": "bestiary/tokens/MM/Doppelganger.webp"
```
^statblock
