...
aliases: ["Roc"]
---
# [Roc](3-Compendium\CLI\bestiary\monstrosity/roc.md)
*Source: Monster Manual p. 260, Dragon of Icespire Peak, Explorer's Guide to Wildemount, Mythic Odysseys of Theros. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: +13 to hit, reach 5 ft., one target. Hit: 23 (4d6\
    ...
    \ grapple ends, the target is restrained, and the roc can't use its talons on\
    \ another target."
  "name": "Talons"
"source":
- "MM"
...
- "EGW"
- "MOT"
"image": "bestiary/tokens/MM/Roc.webp"
```
^statblock
