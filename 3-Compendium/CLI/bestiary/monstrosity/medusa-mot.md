...
aliases: ["Medusa"]
---
# [Medusa](3-Compendium\CLI\bestiary\monstrosity/medusa-mot.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 10 ft., one target. Hit: 7 (2d6)\
    \ bludgeoning damage, and the target is grappled (escape DC 11). Until this grapple\
    \ ends, the target is restrained, and the medusa can't constrict another target."
  "name": "Constrict"
"source":
- "MOT"
"image": "bestiary/tokens/MOT/Medusa.webp"
```
^statblock