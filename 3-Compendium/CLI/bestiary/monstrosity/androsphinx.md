...
aliases: ["Androsphinx"]
---
# [Androsphinx](3-Compendium\CLI\bestiary\monstrosity/androsphinx.md)
...
- "desc": "The sphinx is a 12th-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ (4 slots): command, detect evil and good, detect magic\n\n2nd level (3 slots):\
    \ lesser restoration, zone of truth\n\n3rd level (3 slots): dispel magic,\
    \ tongues\n\n4th level (3 slots): banishment, freedom of movement\n\n5th\
    \ level (2 slots): flame strike, greater restoration\n\n6th level (1 slots):\
    \ heroes' feast"
  "name": "Spellcasting"
...
- "desc": "The sphinx emits a magical roar. Each time it roars before finishing a\
    ...
    \ throw is deafened and frightened for 1 minute. A frightened creature is paralyzed\
    ...
    \ damage and is knocked prone. On a successful save, the creature takes half as\
...
- "EGW"
- "MOT"
"image": "bestiary/tokens/MM/Androsphinx.webp"
```
^statblock
