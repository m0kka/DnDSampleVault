...
aliases: ["Nilbog"]
---
# [Nilbog](3-Compendium\CLI\bestiary\fey/nilbog-mpmm.md)
...
- "desc": "Any creature that attempts to damage the nilbog must first succeed on a\
    \ DC 12 Charisma saving throw or be charmed until the end of the creature's next\
    \ turn. A creature charmed in this way must use its action praising the nilbog.\n\
    \nThe nilbog can't regain hit points, including through magical healing, except\
    \ through its Reversal of Fortune reaction."
  "name": "Nilbogism"
"actions":
...
- "MPMM"
- "VGM"
"image": "bestiary/tokens/MPMM/Nilbog.webp"
```
^statblock
