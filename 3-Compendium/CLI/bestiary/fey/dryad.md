...
aliases: ["Dryad"]
---
# [Dryad](3-Compendium\CLI\bestiary\fey/dryad.md)
...
- "desc": "The dryad targets one humanoid or beast that she can see within 30 feet\
    ...
    \ throw or be magically charmed. The charmed creature regards the dryad as a trusted\
    \ friend to be heeded and protected. Although the target isn't under the dryad's\
    \ control, it takes the dryad's requests or actions in the most favorable way\
    ...
    \ the effect lasts 24 hours or until the dryad dies, is on a different plane of\
    \ existence from the target, or ends the effect as a bonus action. If a target's\
    \ saving throw is successful, the target is immune to the dryad's Fey Charm for\
...
- "MOT"
- "BMT"
"image": "bestiary/tokens/MM/Dryad.webp"
```
^statblock
