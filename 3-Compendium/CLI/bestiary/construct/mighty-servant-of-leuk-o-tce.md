...
- "desc": "If the servant jumps at least 25 feet as part of its movement, it can then\
    ...
    \ save, a creature takes 26 (4d12) bludgeoning damage and is knocked prone. On\
    \ a successful save, a creature takes half as much damage and isn't knocked prone."
  "name": "Crushing Leap"
"source":
- "TCE"
"image": "bestiary/tokens/TCE/Mighty Servant of Leuk-o.webp"
```
^statblock