...
aliases: ["Flesh Golem"]
---
# [Flesh Golem](3-Compendium\CLI\bestiary\construct/flesh-golem.md)
*Source: Monster Manual p. 169, Dragon of Icespire Peak, Explorer's Guide to Wildemount, Mythic Odysseys of Theros. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "EGW"
- "MOT"
"image": "bestiary/tokens/MM/Flesh Golem.webp"
```
^statblock