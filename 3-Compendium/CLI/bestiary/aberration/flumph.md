...
aliases: ["Flumph"]
---
# [Flumph](3-Compendium\CLI\bestiary\aberration/flumph.md)
...
- "desc": "If the flumph is knocked prone, roll a die. On an odd result, the flumph\
    \ lands upside-down and is incapacitated. At the end of each of its turns, the\
    \ flumph can make a DC 10 Dexterity saving throw, righting itself and ending the\
...
- "desc": "Each creature in a 15-foot cone originating from the flumph must succeed\
    ...
    \ is poisoned as long as the stench lasts, and other creatures are poisoned while\
    \ with in 5 feet of the coated creature. A creature can remove the stench on itself\
    \ by using a short rest to bathe in water, alcohol, or vinegar."
  "name": "Stench Spray (1/Day)"
"source":
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Flumph.webp"
```
^statblock
