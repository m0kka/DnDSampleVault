...
aliases: ["Gray Slaad"]
---
# [Gray Slaad](3-Compendium\CLI\bestiary\aberration/gray-slaad.md)
...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \nAt will: detect magic, detect thoughts, invisibility (self only), mage hand,\
...
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Gray Slaad.webp"
```
^statblock
