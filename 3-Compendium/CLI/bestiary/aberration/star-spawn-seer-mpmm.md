...
---
# [Star Spawn Seer](3-Compendium\CLI\bestiary\aberration/star-spawn-seer-mpmm.md)
*Source: Mordenkainen Presents: Monsters of the Multiverse p. 230, Mordenkainen's Tome of Foes p. 236, The Book of Many Things*  
...
- "desc": "The seer can move through other creatures and objects as if they were difficult\
    ...
    \ it moves through takes 5 (1d10) psychic damage; no creature can take this damage\
    \ more than once per turn.\n\nThe seer takes 5 (1d10) force damage if it ends\
...
- "desc": "Melee Weapon Attack: +11 to hit, reach 5 ft., one target. Hit: 10 (1d8\
    ...
    \ creature, it must succeed on a DC 19 Constitution saving throw or be incapacitated\
