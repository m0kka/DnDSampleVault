...
aliases: ["Red Slaad"]
---
# [Red Slaad](3-Compendium\CLI\bestiary\aberration/red-slaad.md)
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 5 ft., one target. Hit: 7 (1d8\
    ...
    \ the egg moves to the chest cavity, gestates, and forms a [slaad tadpole](/3-Compendium/CLI/bestiary/aberration/slaad-tadpole-xphb.md).\
...
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Red Slaad.webp"
```
^statblock