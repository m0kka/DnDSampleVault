...
aliases: ["Grell"]
---
# [Grell](3-Compendium\CLI\bestiary\aberration/grell.md)
...
- "desc": "Melee Weapon Attack: +4 to hit, reach 10 ft., one creature. Hit: 7\
    ...
    \ saving throw or be poisoned for 1 minute. The poisoned target is paralyzed,\
    \ and it can repeat the saving throw at the end of each of its turns, ending the\
    \ effect on a success.\n\nThe target is also grappled (escape DC 15). If the target\
    \ is Medium or smaller, it is also restrained until this grapple ends. While grappling\
    \ the target, the grell has advantage on attack rolls against it and can 't use\
    \ this attack against other targets. When the grell moves, any Medium or smaller\
    \ target it is grappling moves with it."
  "name": "Tentacles"
...
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Grell.webp"
```
^statblock
