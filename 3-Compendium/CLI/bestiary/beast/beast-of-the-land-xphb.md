...
---
# [Beast of the Land](3-Compendium\CLI\bestiary\beast/beast-of-the-land-xphb.md)
...
- "desc": "Melee Attack: YourSpellAttack Bonus equals your spell attack modifier,\
    ...
    \ an extra 1d6 damage of the same type, and the target has the [Prone](/3-Compendium/CLI/rules/conditions.md#Prone)\
    \ condition if it is a Large or smaller creature."
  "name": "Beast's Strike"
"source":
- "XPHB"
"image": "bestiary/tokens/XPHB/Beast of the Land.webp"
```
^statblock