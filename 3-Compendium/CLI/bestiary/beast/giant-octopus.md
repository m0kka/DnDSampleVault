...
---
# [Giant Octopus](3-Compendium\CLI\bestiary\beast/giant-octopus.md)
*Source: Monster Manual p. 326, Explorer's Guide to Wildemount, Mythic Odysseys of Theros, Tasha's Cauldron of Everything. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)*  
...
- "desc": "Melee Weapon Attack: +5 to hit, reach 15 ft., one target. Hit: 10 (2d6\
    \ + 3) bludgeoning damage. If the target is a creature, it is grappled (escape\
    \ DC 16). Until this grapple ends, the target is restrained, and the octopus can't\
...
- "MOT"
- "TCE"
"image": "bestiary/tokens/MM/Giant Octopus.webp"
```
^statblock
