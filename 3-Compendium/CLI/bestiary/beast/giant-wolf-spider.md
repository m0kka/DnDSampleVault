...
---
# [Giant Wolf Spider](3-Compendium\CLI\bestiary\beast/giant-wolf-spider.md)
...
- "desc": "Melee Weapon Attack: +3 to hit, reach 5 ft., one creature. Hit: 4 (1d6\
    ...
    \ stable but poisoned for 1 hour, even after regaining hit points, and is paralyzed\
    \ while poisoned in this way."
  "name": "Bite"
"source":
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Giant Wolf Spider.webp"
```
^statblock
