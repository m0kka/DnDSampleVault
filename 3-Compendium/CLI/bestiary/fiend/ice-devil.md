...
aliases: ["Ice Devil"]
---
# [Ice Devil](3-Compendium\CLI\bestiary\fiend/ice-devil.md)
...
- "desc": "The devil magically forms an opaque wall of ice on a solid surface it can\
    ...
    \ creature is incapacitated. The creature then makes a DC 17 Dexterity saving\
    \ throw, taking 35 (10d6) cold damage on a failed save, or half as much damage\
...
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Ice Devil.webp"
```
^statblock