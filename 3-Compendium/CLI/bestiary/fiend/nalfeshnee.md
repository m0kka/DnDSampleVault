...
aliases: ["Nalfeshnee"]
---
# [Nalfeshnee](3-Compendium\CLI\bestiary\fiend/nalfeshnee.md)
*Source: Monster Manual p. 62, The Book of Many Things. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "The nalfeshnee magically emits scintillating, multicolored light. Each\
    ...
    \ on a DC 15 Wisdom saving throw or be frightened for 1 minute. A creature can\
    \ repeat the saving throw at the end of each of its turns, ending the effect on\
    \ itself on a success. If a creature's saving throw is successful or the effect\
    \ ends for it, the creature is immune to the nalfeshnee's Horror Nimbus for the\
    \ next 24 hours."
...
- "MM"
- "BMT"
"image": "bestiary/tokens/MM/Nalfeshnee.webp"
```
^statblock