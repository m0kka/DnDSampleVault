...
---
# [Night Hag (Coven)](3-Compendium\CLI\bestiary\fiend/night-hag-coven.md)
...
- "desc": "While all three members of a hag coven are within 30 feet of one another,\
    ...
    \ (3 slots): phantasmal killer, polymorph\n\n5th level (2 slots): contact\
    \ other plane, scrying\n\n6th level (1 slots): eyebite\n\nFor casting these\
    \ spells, each hag is a 12th-level spellcaster that uses Intelligence as her spellcasting\
    \ ability. The spell save DC 15, and the spell attack bonus is +7."
...
- "desc": "While on the Ethereal Plane, the hag magically touches a sleeping humanoid\
    ...
    \ target dies, and if the target was evil, its soul is trapped in the hag's soul\
    \ bag. The reduction to the target's hit point maximum lasts until removed by\
