...
aliases: ["Nycaloth"]
---
# [Nycaloth](3-Compendium\CLI\bestiary\fiend/nycaloth.md)
...
- "desc": "The nycaloth's innate spellcasting ability is Charisma. The nycaloth can\
    ...
    \ will: darkness, detect magic, dispel magic, invisibility (self only), mirror\
    \ image"
...
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Nycaloth.webp"
```
^statblock