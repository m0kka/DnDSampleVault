...
aliases: ["Glabrezu"]
---
# [Glabrezu](3-Compendium\CLI\bestiary\fiend/glabrezu.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one target. Hit: 16 (2d10\
    ...
    \ grappled (escape DC 15). The glabrezu has two pincers, each of which can grapple\
    \ only one target."
  "name": "Pincer"
...
- "EGW"
- "BMT"
"image": "bestiary/tokens/MM/Glabrezu.webp"
```
^statblock