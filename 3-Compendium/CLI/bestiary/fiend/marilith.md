...
aliases: ["Marilith"]
---
# [Marilith](3-Compendium\CLI\bestiary\fiend/marilith.md)
...
- "desc": "Melee Weapon Attack: +9 to hit, reach 10 ft., one creature. Hit: 15\
    \ (2d10 + 4) bludgeoning damage. If the target is Medium or smaller, it is grappled\
...
- "EGW"
- "TCE"
"image": "bestiary/tokens/MM/Marilith.webp"
```
^statblock