...
aliases: ["Hezrou"]
---
# [Hezrou](3-Compendium\CLI\bestiary\fiend/hezrou.md)
...
- "desc": "Any creature that starts its turn within 10 feet of the hezrou must succeed\
    \ on a DC 14 Constitution saving throw or be poisoned until the start of its next\
    \ turn. On a successful saving throw, the creature is immune to the hezrou's stench\
    \ for 24 hours."
  "name": "Stench"
"actions":
...
- "EGW"
- "BMT"
"image": "bestiary/tokens/MM/Hezrou.webp"
```
^statblock