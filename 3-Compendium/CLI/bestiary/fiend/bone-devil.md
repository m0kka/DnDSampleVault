...
aliases: ["Bone Devil"]
---
# [Bone Devil](3-Compendium\CLI\bestiary\fiend/bone-devil.md)
*Source: Monster Manual p. 71, Dragon of Icespire Peak, Explorer's Guide to Wildemount. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>*  
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 10 ft., one target. Hit: 13 (2d8\
    ...
    \ on a DC 14 Constitution saving throw or become poisoned for 1 minute. The target\
...
- "DIP"
- "EGW"
"image": "bestiary/tokens/MM/Bone Devil.webp"
```
^statblock