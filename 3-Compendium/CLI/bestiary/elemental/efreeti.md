...
aliases: ["Efreeti"]
---
# [Efreeti](3-Compendium\CLI\bestiary\elemental/efreeti.md)
...
- "desc": "The efreeti's innate spellcasting ability is Charisma (spell save DC 15,\
    ...
    \ elemental ([fire elemental](/3-Compendium/CLI/bestiary/elemental/fire-elemental-xmm.md)\
    \ only), gaseous form, invisibility, major image, plane shift, wall of fire\n\n\
...
- "EGW"
- "TCE"
"image": "bestiary/tokens/MM/Efreeti.webp"
```
^statblock
