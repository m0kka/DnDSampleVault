...
aliases: ["Dao"]
---
# [Dao](3-Compendium\CLI\bestiary\elemental/dao.md)
...
- "desc": "The dao's innate spellcasting ability is Charisma (spell save DC 14, +6\
    ...
    \ stone shape\n\n1/day each: conjure elemental ([earth elemental](/3-Compendium/CLI/bestiary/elemental/earth-elemental.md)\
...
- "MM"
- "TCE"
"image": "bestiary/tokens/MM/Dao.webp"
```
^statblock
