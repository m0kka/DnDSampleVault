...
aliases: ["Empyrean"]
---
# [Empyrean](3-Compendium\CLI\bestiary\celestial/empyrean.md)
...
- "desc": "The empyrean's innate spellcasting ability is Charisma (spell save DC 23,\
    ...
    \ no material components:\n\nAt will: greater restoration, pass without trace,\
    \ water breathing, water walk\n\n1/day each: commune, dispel evil and good,\
    \ earthquake, fire storm, plane shift (self only)"
...
- "desc": "Melee Weapon Attack: +17 to hit, reach 10 ft., one target. Hit: 31\
    ...
    \ on a DC 15 Constitution saving throw or be stunned until the end of the empyrean's\
    \ next turn."
  "name": "Maul"
...
- "desc": "The empyrean bolsters all nonhostile creatures within 120 feet of it until\
    \ the end of its next turn. Bolstered creatures can't be charmed or frightened,\
    \ and they gain advantage on ability checks and saving throws until the end of\
...
- "desc": "The empyrean strikes the ground with its maul, triggering an earth tremor.\
    ...
    \ on a DC 25 Strength saving throw or be knocked prone."
  "name": "Trembling Strike (Costs 2 Actions)"
"source":
- "MM"
- "MOT"
- "BMT"
"image": "bestiary/tokens/MM/Empyrean.webp"
```
^statblock