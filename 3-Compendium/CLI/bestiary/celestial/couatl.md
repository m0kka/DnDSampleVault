...
aliases: ["Couatl"]
---
# [Couatl](3-Compendium\CLI\bestiary\celestial/couatl.md)
...
- "desc": "The couatl's spellcasting ability is Charisma (spell save DC 14). It can\
    ...
    \ will: detect evil and good, detect magic, detect thoughts\n\n1/day each:\
    \ dream, greater restoration, scrying\n\n3/day each: bless, create food and\
    \ water, cure wounds, lesser restoration, protection from poison, sanctuary, shield"
...
- "desc": "Melee Weapon Attack: +8 to hit, reach 5 ft., one creature. Hit: 8 (1d6\
    ...
    \ throw or be poisoned for 24 hours. Until this poison ends, the target is unconscious.\
...
- "desc": "Melee Weapon Attack: +6 to hit, reach 10 ft., one Medium or smaller creature.\
    \ Hit: 10 (2d6 + 3) bludgeoning damage, and the target is grappled (escape DC\
    \ 15). Until this grapple ends, the target is restrained, and the couatl can't\
...
- "EGW"
- "BMT"
"image": "bestiary/tokens/MM/Couatl.webp"
```
^statblock
