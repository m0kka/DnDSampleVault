...
---
# [Karkethzerethzerus, the Sable Despoiler](3-Compendium\CLI\bestiary\npc/karkethzerethzerus-the-sable-despoiler-egw.md)
...
- "desc": "The dragon uses one of the following breath weapons.\n\n- Necrotic Breath.\
    ...
    \ in that area must succeed on a DC 24 Constitution saving throw or be paralyzed\
    \ for 1 minute. A creature can repeat the saving throw at the end of each of its\
...
"source":
- "EGW"
"image": "bestiary/tokens/EGW/Karkethzerethzerus, the Sable Despoiler.webp"
```
^statblock