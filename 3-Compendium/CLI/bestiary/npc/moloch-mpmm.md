...
aliases: ["Moloch"]
---
# [Moloch](3-Compendium\CLI\bestiary\npc/moloch-mpmm.md)
...
- "desc": "Moloch casts one of the following spells, requiring no material components\
    ...
    \ alter self (can become Medium when changing his appearance), confusion, detect\
    \ magic, fly, major image, stinking cloud, suggestion, wall of fire"
  "name": "Spellcasting"
...
- "desc": "Melee Weapon Attack: +15 to hit, reach 30 ft., one target. Hit: 13\
    \ (2d4 + 8) lightning damage plus 11 (2d10) thunder damage. If the target is a\
    \ creature, it must succeed on a DC 24 Strength saving throw or be pulled up to\
    \ 30 feet in a straight line toward Moloch."
...
- "desc": "Moloch exhales in a 30-foot cube. Each creature in that area must succeed\
    ...
    \ it is holding, and become frightened of Moloch for 1 minute. While frightened\
