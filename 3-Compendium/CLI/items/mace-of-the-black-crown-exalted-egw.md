...
- While holding the mace, you can use an action to summon an [imp](imp-xphb.md). Any devil you summon with this mace is friendly to you and your companions for the duration. The imp obeys any verbal commands that you issue to it and returns to the Nine Hells 10 minutes after you summoned it. This property can't be used again until the next dawn.  
...
- The weapon's Summon Devil feature can also be used to summon a [bearded devil](bearded-devil.md).  
...
- The weapon's Summon Devil feature can also be used to summon a [barbed devil](barbed-devil.md).  
