...
You have [Resistance](3-Compendium/CLI/rules/variant-rules/resistance-xphb.md) to Fire damage while you hold this staff.
...
| Spell | Charge Cost |
|-------|-------------|
| [Burning Hands](/3-Compendium/CLI/spells/burning-hands-xphb.md) | 1 |
| [Fireball](fireball-xphb.md) | 3 |
| [Wall of Fire](wall-of-fire-xphb.md) | 4 |
^spell-charge-cost

## Regaining Charges

The staff regains `1d6 + 4` expended charges daily at dawn. If you expend the last charge, roll ``. On a 1, the staff crumbles into cinders and is destroyed.
